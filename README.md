...
[tokei](https://github.com/XAMPPRocky/tokei) — count your code, quickly — packaged for
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/tokei-debian/releases) page:

```sh
sudo dpkg -i tokei_*.deb
```
...
Run the [Build tokei for Debian](../../actions) workflow on GitHub with the
...
Unofficial packaging only. For issues with tokei itself, see
